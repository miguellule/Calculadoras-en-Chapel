// este programa calcula la resta de matrices en secuencial cuando
//el usuario ingresa cada valor de los vectores de la matriz
...
// Resta de las matrices en secuencial
for i in 1..3 {
    for j in 1..3 {
        var sum: int = 0;
        for k in 1..3 {
